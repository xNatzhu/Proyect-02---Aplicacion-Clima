...
window.addEventListener("load",()=>{
  ...
  //Variables
    ...
    if(navigator.geolocation){
        ...
        //Funcion de item de estatico de la web y funcion para buscar la ciudad
        function itemEstatico () {
          const URLESTATICA = `https://api.openweathermap.org/data/2.5/weather?q=${ciudadURL},uk&APPID=6752644c4b10d307e40b484055d4f5a5`
        ...
        //Funcion que se cumple cuando dan permitir
